...
<c:if test="${type.equals('student')}">
	<c:if test="${which.equals('student')}">
		<header>
	        <h1>Update Account</h1>
 ...
 <c:if test="${which.equals('project')}">
 	<header>
	        <h1>Update Account</h1>
    ...
    <div id="side-menu" class="side-nav">
	    ...
	    <h2 class='h2'>Welcome, ${name}! Your current project information is below</h2>
