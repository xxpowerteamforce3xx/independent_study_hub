...
public class SelectAllPendingFacultyControllerTest {
	private SelectAllPendingFacultyController controller;
	private ArrayList<Faculty> fac_list = new ArrayList<Faculty>();

	@Before
	public void setUp() throws Exception {
		controller = new SelectAllPendingFacultyController();
	}

	@Test
	public void test_sql_query_select_all() {
		fac_list = controller.get_all_pending_faculty();
